...
<ParamField path="ZEROBREW_ROOT" type="string" default="/opt/zerobrew">
...
<ParamField path="ZEROBREW_PREFIX" type="string" default="$ZEROBREW_ROOT/prefix">
  The installation prefix where executables and libraries are linked.
  
  This directory is added to your PATH.
</ParamField>

<ParamField path="ZEROBREW_DIR" type="string" default="~/.zerobrew">
  The source code directory where zerobrew is cloned during installation.
</ParamField>

<ParamField path="ZEROBREW_BIN" type="string" default="~/.local/bin">
